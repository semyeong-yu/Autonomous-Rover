...
set(MSG_I_FLAGS "-Ichassis_control:/home/ee405/catkin_ws/src/chassis_control/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ee405/catkin_ws/src/chassis_control/msg/SetVelocity.msg" NAME_WE)
add_custom_target(_chassis_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "chassis_control" "/home/ee405/catkin_ws/src/chassis_control/msg/SetVelocity.msg" ""
)

get_filename_component(_filename "/home/ee405/catkin_ws/src/chassis_control/msg/SetTranslation.msg" NAME_WE)
add_custom_target(_chassis_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "chassis_control" "/home/ee405/catkin_ws/src/chassis_control/msg/SetTranslation.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/chassis_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/chassis_control\")")
  # install generated code
  install(

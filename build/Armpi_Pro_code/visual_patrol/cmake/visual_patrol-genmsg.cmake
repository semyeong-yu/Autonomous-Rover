...
get_filename_component(_filename "/home/ee405/catkin_ws/src/Armpi_Pro_code/visual_patrol/srv/SetTarget.srv" NAME_WE)
add_custom_target(_visual_patrol_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "visual_patrol" "/home/ee405/catkin_ws/src/Armpi_Pro_code/visual_patrol/srv/SetTarget.srv" ""
)
...
_generate_srv_cpp(visual_patrol
  "/home/ee405/catkin_ws/src/Armpi_Pro_code/visual_patrol/srv/SetTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/visual_patrol)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/visual_patrol\")")
  # install generated code
  install(
